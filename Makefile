...
docs: docs/compilation.html docs/proof.html
	echo "<html> <body> <h1> Alectryon files for CertiCoq Wasm backend (`git rev-parse --short HEAD`, `date --iso-8601`)</h1> - <a href='compilation.html'> Compilation </a> <br> <br> - <a href='proof.html'> Correctness proof </a> (This file is big) </body </html>" > docs/index.html
