...
//        let bytes = obj.instance.exports.bytes_used.value;
 ...
 //       const res_value = obj.instance.exports.result.value;
        ...
        console.log(obj.instance.exports.result.value);
...
//        obj.instance.exports.pretty_print_constructor(res_value); console.log(""); // newline
        ...
        console.log(`Benchmark ${path}: {{"time_startup": "${time_startup}", "time_main": "${time_main}", "time_pp": "${time_pp}", "bytes_used": "0", "program": "${program}"}} ms, bytes.`);
    } catch (error) {
        console.log(error);
        process.exit(1);
    }
